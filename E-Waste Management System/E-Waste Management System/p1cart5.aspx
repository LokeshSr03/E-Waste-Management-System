<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p1cart5.aspx.cs" Inherits="E_Waste_Management_System.p1cart5" %>
...
<img src="P1(5M).png" class="img-fluid" alt="cart img"/>
</div>
...
<asp:Label ID="pname" runat="server" Text=""><h1 class="mb-4 product_name" >OPPO A74</h1></asp:Label>
...
<h3>$<span id="itemval">200.00 </span></h3>
</div>
</div>
</div>
</div>
...
<p>Product amount</p>
<p>$<span id="product_total_amt">200.00</span></p>
</div>
<div class="price_indiv d-flex justify-content-between">
<p>Shipping Charge</p>
...
<p>Total amount</p>
<asp:Label ID="TAmt" runat="server" Text=""><p>$<span id="total_cart_amt">205.00</span></p></asp:Label>
</div>
