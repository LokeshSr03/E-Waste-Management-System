<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p3cart7.aspx.cs" Inherits="E_Waste_Management_System.p3cart7" %>
...
<img src="P3(7L).png" class="img-fluid" alt="cart img"/>
</div>
...
<asp:Label ID="pname" runat="server" Text=""><h1 class="mb-4 product_name" >Asus Flex</h1></asp:Label>
...
<h3>$<span id="itemval">650.00 </span></h3>
</div>
</div>
</div>
</div>
...
<p>Product amount</p>
<p>$<span id="product_total_amt">650.00</span></p>
</div>
<div class="price_indiv d-flex justify-content-between">
<p>Shipping Charge</p>
...
<p>Total amount</p>
<asp:Label ID="TAmt" runat="server" Text=""><p>$<span id="total_cart_amt">655.00</span></p></asp:Label>
</div>
...
<script type="text/javascript">
    ...
    const discount_code = () => {
        ...
        if (discountCode.value === 'A235BDS67LK23') {
            let newtotalamt = totalamtcurr - 650;
