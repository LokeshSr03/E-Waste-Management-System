<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p3cart6.aspx.cs" Inherits="E_Waste_Management_System.p3cart6" %>
...
<img src="P3(6T).png" class="img-fluid" alt="cart img"/>
</div>
...
<asp:Label ID="pname" runat="server" Text=""><h1 class="mb-4 product_name" >VU 4K 43</h1></asp:Label>
