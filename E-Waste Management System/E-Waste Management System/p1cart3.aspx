<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p1cart3.aspx.cs" Inherits="E_Waste_Management_System.p1cart3" %>
...
<img src="P1(3M).png" class="img-fluid" alt="cart img"/>
</div>
...
<asp:Label ID="pname" runat="server" Text=""><h1 class="mb-4 product_name" >iQoo Z6</h1></asp:Label>
...
<p>Total amount</p>
<asp:Label ID="TAmt" runat="server" Text=""><p>$<span id="total_cart_amt">325.00</span></p></asp:Label>
</div>
