<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p1cart4.aspx.cs" Inherits="E_Waste_Management_System.p1cart4" %>
...
<img src="P1(4T).png" class="img-fluid" alt="cart img"/>
</div>
...
<asp:Label ID="pname" runat="server" Text=""><h1 class="mb-4 product_name" >LG Smart T1</h1></asp:Label>
...
<p>Product amount</p>
<p>$<span id="product_total_amt">99.00</span></p>
</div>
<div class="price_indiv d-flex justify-content-between">
<p>Shipping Charge</p>
...
<p>Total amount</p>
<asp:Label ID="TAmt" runat="server" Text=""><p>$<span id="total_cart_amt">104.00</span></p></asp:Label>
</div>
