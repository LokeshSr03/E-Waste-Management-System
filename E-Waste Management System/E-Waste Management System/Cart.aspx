<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="E_Waste_Management_System.Cart" %>
...
<h1 class="mb-4 product_name">Redmi note 10</h1>
...
<asp:HyperLink runat="server" ID="HyperLink" NavigateUrl="FeedBack.aspx"><button class="btn btn-primary text-uppercase">Checkout</button></asp:HyperLink>
</div>
<!-- discount code part -->
...
<small id="error_trw" class="text-dark mt-3">code is Lokesh</small>
</div>
...
<script type="text/javascript">
    ...
    const discount_code = () => {
        ...
        if (discountCode.value === 'A235BDS67LK23') {
            ...
            error_trw.innerHTML = "Try Again! Valid code is Lokesh";
        }
    }
</script>
    </form>
