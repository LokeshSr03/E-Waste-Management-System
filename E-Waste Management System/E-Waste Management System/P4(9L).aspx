<%@ Page Title="" Language="C#" MasterPageFile="~/NavFoot.Master" AutoEventWireup="true" CodeBehind="P4(9L).aspx.cs" Inherits="E_Waste_Management_System.P4_9L_" %>
            ...
            <div class="col-2H">
                ...
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="../P3(9L).png" width="100%" class="small-img" />
                    </div>
                    <div class="small-img-col">
                        <img src="../P3(9L2).png" width="100%" class="small-img" />
                    </div>
                    <div class="small-img-col">
                        <img src="../P3(9L3).png" width="100%" class="small-img" />
                    </div>
                    <div class="small-img-col">
                        <img src="../P3(9L4).png" width="100%" class="small-img" />
                    </div>
                </div>
            </div>
            <div class="col-2H" style="margin-top:0;">
                <p style="margin-top:0;"><a href="HomePage.aspx">Home/</a><a href="C(L).aspx">Laptops</a></p>
                <h1 >Mi Notebook U1</h1>
