<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cart(H1).aspx.cs" Inherits="E_Waste_Management_System.Cart_H1_" %>
...
<img src="H1(M).png" class="img-fluid" alt="cart img"/>
</div>
...
<asp:Label ID="pname" runat="server" Text=""><h1 class="mb-4 product_name" >Redmi note 10</h1></asp:Label>
