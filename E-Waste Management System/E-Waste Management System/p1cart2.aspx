<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p1cart2.aspx.cs" Inherits="E_Waste_Management_System.p1cart2" %>
...
<img src="P1(2C).png" class="img-fluid" alt="cart img"/>
</div>
...
<asp:Label ID="pname" runat="server" Text=""><h1 class="mb-4 product_name" >Lumix L10</h1></asp:Label>
