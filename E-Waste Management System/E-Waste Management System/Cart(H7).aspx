<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cart(H7).aspx.cs" Inherits="E_Waste_Management_System.Cart_H7_" %>
...
<img src="H7(M).png" class="img-fluid" alt="cart img"/>
</div>
...
<asp:Label ID="pname" runat="server" Text=""><h1 class="mb-4 product_name" >Samsung M32</h1></asp:Label>
