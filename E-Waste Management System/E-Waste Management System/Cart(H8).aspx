<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cart(H8).aspx.cs" Inherits="E_Waste_Management_System.Cart_H8_" %>
...
<img src="H8(T).png" class="img-fluid" alt="cart img"/>
</div>
...
<asp:Label ID="pname" runat="server" Text=""><h1 class="mb-4 product_name" >Motorola Q2 TV</h1></asp:Label>
