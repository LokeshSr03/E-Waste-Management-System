<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p2cart2.aspx.cs" Inherits="E_Waste_Management_System.p2cart2" %>
...
<img src="P2(2T).png" class="img-fluid" alt="cart img"/>
</div>
...
<asp:Label ID="pname" runat="server" Text=""><h1 class="mb-4 product_name" >MI 43</h1></asp:Label>
