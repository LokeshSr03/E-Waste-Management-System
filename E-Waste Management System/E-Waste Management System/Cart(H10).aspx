<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cart(H10).aspx.cs" Inherits="E_Waste_Management_System.Cart_H10_" %>
...
<img src="H10(M).png" class="img-fluid" alt="cart img"/>
</div>
...
<asp:Label ID="pname" runat="server" Text=""><h1 class="mb-4 product_name" >Realme narzo 50i</h1></asp:Label>
...
<h3>$<span id="itemval">55.00 </span></h3>
</div>
</div>
</div>
</div>
...
<p>Product amount</p>
<p>$<span id="product_total_amt">55.00</span></p>
</div>
<div class="price_indiv d-flex justify-content-between">
<p>Shipping Charge</p>
...
<p>Total amount</p>
<asp:Label ID="TAmt" runat="server" Text=""><p>$<span id="total_cart_amt">60.00</span></p></asp:Label>
</div>
...
<script type="text/javascript">
    ...
    const decreaseNumber = (incdec, itemprice) => {
        ...
        if (itemval.value <= 0) {
            ...
            itemprice.innerHTML = parseInt(itemprice.innerHTML) - 55;
            product_total_amt.innerHTML = parseInt(product_total_amt.innerHTML) - 55;
