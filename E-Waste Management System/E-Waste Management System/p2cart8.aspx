<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p2cart8.aspx.cs" Inherits="E_Waste_Management_System.p2cart8" %>
...
<img src="P2(8T).png" class="img-fluid" alt="cart img"/>
</div>
...
<asp:Label ID="pname" runat="server" Text=""><h1 class="mb-4 product_name" >VU Prime 43</h1></asp:Label>
...
<h3>$<span id="itemval">285.00 </span></h3>
</div>
</div>
</div>
</div>
...
<p>Product amount</p>
<p>$<span id="product_total_amt">285.00</span></p>
</div>
<div class="price_indiv d-flex justify-content-between">
<p>Shipping Charge</p>
...
<p>Total amount</p>
<asp:Label ID="TAmt" runat="server" Text=""><p>$<span id="total_cart_amt">290.00</span></p></asp:Label>
</div>
...
<script type="text/javascript">
    ...
    const decreaseNumber = (incdec, itemprice) => {
        ...
        if (itemval.value <= 0) {
            ...
            itemprice.innerHTML = parseInt(itemprice.innerHTML) - 285;
            product_total_amt.innerHTML = parseInt(product_total_amt.innerHTML) - 285;
    ...
    const discount_code = () => {
        ...
        if (discountCode.value === 'A235BDS67LK23') {
            let newtotalamt = totalamtcurr - 285;
