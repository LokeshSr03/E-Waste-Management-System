<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cart(H2).aspx.cs" Inherits="E_Waste_Management_System.Cart_H2_" %>
...
<img src="H2(T).png" class="img-fluid" alt="cart img"/>
</div>
...
<asp:Label ID="pname" runat="server" Text=""><h1 class="mb-4 product_name" >OnePlus TV 32Y1</h1></asp:Label>
...
<h3>$<span id="itemval">99.00 </span></h3>
</div>
</div>
</div>
</div>
...
<p>Product amount</p>
<p>$<span id="product_total_amt">104.00</span></p>
</div>
<div class="price_indiv d-flex justify-content-between">
<p>Shipping Charge</p>
...
<p>Total amount</p>
<asp:Label ID="TAmt" runat="server" Text=""><p>$<span id="total_cart_amt">20.00</span></p></asp:Label>
</div>
