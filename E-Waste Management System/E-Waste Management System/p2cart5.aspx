<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p2cart5.aspx.cs" Inherits="E_Waste_Management_System.p2cart5" %>
...
<img src="P2(5L).png" class="img-fluid" alt="cart img"/>
</div>
...
<asp:Label ID="pname" runat="server" Text=""><h1 class="mb-4 product_name" >Apple Macbook Pro</h1></asp:Label>
